    ...
    <Container maxWidth="lg">
      ...
      >
        <NFTGrid
          ...
          emptyText="Looks like you don't have any Assests on EquiKey. Head to the buy page to buy some!"
        />
      </div>
      ...
      >
        {loadingDirects ? (
          ...
          <p>Nothing for sale yet! Head to the sell tab to list an Assest.</p>
        ) : (
